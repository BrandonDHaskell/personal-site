...
const Bio: React.FC = () => {
    ...
    return (
        <div>
            ...
            <p>
                During my ten-year tenure at Amazon, I have taken on roles with increasing responsibilities. Starting as selling account specialist including Technical Program Manager for Amazon Care, where I collaborated closely with engineering, change program management, compliance, and operations teams. My technical training includes Full Stack development in MERN (MongoDB, Express, React, Node) and experience programming in JavaScript, HTML, CSS, Java, Python, C++, C, SQL, VBA, and TypeScript. My key areas of expertise encompass Web Development, Technical Program Management, and Systems Administration.
            </p>
        </div>
    );
};
